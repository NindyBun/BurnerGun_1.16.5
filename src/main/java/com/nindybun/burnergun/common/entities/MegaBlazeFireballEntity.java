...
public class MegaBlazeFireballEntity extends DamagingProjectileEntity {
    ...
    @OnlyIn(Dist.CLIENT)
    public MegaBlazeFireballEntity(World p_i46775_1_, double p_i46775_2_, double p_i46775_4_, double p_i46775_6_, double p_i46775_8_, double p_i46775_10_, double p_i46775_12_) {
